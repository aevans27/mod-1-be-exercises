...
#https://stackoverflow.com/questions/54792469/use-reduce-to-modify-certain-words-in-a-string-in-ruby
  it 'capitalize key words in phrase' do
    keywords = ["fish", "blue"]
    # initial value is 'one fish two fish red fish blue fish'
    result = keywords.reduce("one fish two fish red fish blue fish") do |difference, word|
      difference.gsub(word, word.upcase)
    end
